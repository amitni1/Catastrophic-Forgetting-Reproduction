...
- [Ai medotology](ocs/EWC_Model.md) - Documentation on the use of ai to code and assmble to the project.  
- [validation and testing ](Docs/EWC_Model.md) - a short explain on the vaildation and testing of EWC in the project.
